<template>
  ...
  <form method="post" class="form-horizontal" @submit.prevent="doNote">
      <div class="input-group mb-3">
          ...
          <!--input type="text" class="form-control" placeholder="no title" aria-describedby="button-addon2"-->
      ...
      <div class="form-group">
          <div class="input-group mb-3">
              ...
              <select :value="folder" class="custom-select" id="inputGroupSelect01">
      ...
      <div class="form-group">
        <textarea class="form-control" :value="body" @input="updateBody"></textarea>
